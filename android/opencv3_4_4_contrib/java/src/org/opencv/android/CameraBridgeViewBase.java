...
//        Log.d("mfpsmeter","enable fps");
        if (mFpsMeter == null) {
//            Log.d("mfpsmeter","set resolution");
    ...
    private void onEnterStartedState() {
        ...
        /* Connect camera */
        Log.d("onEnterStartedState", "" + getWidth() + ", " + getHeight());
...
//        Log.d("deliverAndDraw", "orientation: " + getOrientation());
//        Log.d("deliverAndDraw", "screenRotation: " + getScreenRotation());
        if (getOrientation() == Configuration.ORIENTATION_PORTRAIT) {
            ...
            Log.d("deliverAndDraw", "screenRotation = Surface.ROTATION_270 " );
            Core.flip(modified, modified, -1);
        }
//        Log.d("deliverAndDraw", "modified.width: " + modified.width());
//        Log.d("deliverAndDraw", "modified.height: " + modified.height());
//        Log.d("deliverAndDraw", "modified.cols: " + modified.cols());
//        Log.d("deliverAndDraw", "modified.rows: " + modified.rows());
//        Log.d("deliverAndDraw", "mCacheBitmap.width: " + mCacheBitmap.getWidth());
//        Log.d("deliverAndDraw", "mCacheBitmap.height: " + mCacheBitmap.getHeight());

        if(modified.height()!= mCacheBitmap.getHeight() && modified.width()!= mCacheBitmap.getWidth()){
            mCacheBitmap = Bitmap.createBitmap(mCacheBitmap.getHeight(), mCacheBitmap.getWidth(), Bitmap.Config.ARGB_8888);
        }
...
//                }
                ...
                if (mFpsMeter != null) {
//                    Log.d("mfpsmeter","mfpsmeter.draw");
                    mFpsMeter.measure();
...
//    }
    ...
    {
        Log.d("AllocateCache", "orientation: " + getOrientation());
        Log.d("AllocateCache", "mFrameWidth: " + mFrameWidth + ", mFrameHeight: " + mFrameHeight);
    ...
    protected Size calculateCameraFrameSize(List<?> supportedSizes, ListItemAccessor accessor, int surfaceWidth, int surfaceHeight) {
        int calcWidth = 0;
        int calcHeight = 0;
        int surfaceWidthTemp = surfaceWidth;
        surfaceWidth = surfaceHeight;
        surfaceHeight =surfaceWidthTemp;


        int maxAllowedWidth = (mMaxWidth != MAX_UNSPECIFIED && mMaxWidth < surfaceWidth)? mMaxWidth : surfaceWidth;
        int maxAllowedHeight = (mMaxHeight != MAX_UNSPECIFIED && mMaxHeight < surfaceHeight)? mMaxHeight : surfaceHeight;
        Log.d("mMaxWidth", "" + mMaxWidth);
        Log.d("mMaxHeight", "" + mMaxHeight);
        Log.d("surfaceWidth", "" + surfaceWidth);
        Log.d("surfaceHeight", "" + surfaceHeight);
        Log.d("maxAllowedWidth", "" + maxAllowedWidth);
        Log.d("maxAllowedHeight", "" + maxAllowedHeight);
        for (Object size : supportedSizes) {
            int width = accessor.getWidth(size);
            int height = accessor.getHeight(size);
            Log.d("SupportedSize", "w: " + width + ", h:" + height);
...
//        int w = mMaxWidth != MAX_UNSPECIFIED ? mMaxWidth : accessor.getWidth(supportedSizes.get(5));
//        int h = mMaxHeight != MAX_UNSPECIFIED ? mMaxHeight : accessor.getHeight(supportedSizes.get(5));
//        Log.d("w", "" + w);
//        Log.d("h", "" + h);
//        return new Size(w, h);
...
//        switch (setQuality) {
//            case 0:
//                size = acceptedSizes.get(acceptedSizes.size() - 1);
//            case 1:
//                size = acceptedSizes.get(acceptedSizes.size() / 2);
//            default:
//                size = acceptedSizes.get(0);
//        }
//        Log.d("SizeOfFrame", "" + size.width + ", " + size.height);
//
//        return size;
