...
public class JavaCameraView extends CameraBridgeViewBase implements PreviewCallback {
    ...
    private void applyAspect(int surfaceWidth, int surfaceHeight) {
        Log.d("getOrientation", "" + getOrientation());
        Log.d("applyAspect", "mFrameWidth" + mFrameWidth);
        Log.d("applyAspect", "mFrameHeight" + mFrameHeight);
        ...
        Log.d("applyAspect", "frameWidth" + frameWidth);
        Log.d("applyAspect", "frameHeight" + frameHeigth);
        switch (aspect) {
            case ALPRCameraAspectFit:
            case ALPRCameraAspectFill:
                Log.d("applyAspect", "aspect= " + aspect);
                Log.d("applyAspect", "srufaceWidth= " + surfaceWidth);
                Log.d("applyAspect", "surfaceHeight= " + surfaceHeight);
                Log.d("applyAspect", "frameWidth= " + frameWidth);
                Log.d("applyAspect", "frameHeight= " + frameHeigth);
                ...
                Log.d("widthOffset", "" + widthOffset);
                Log.d("heightOffset", "" + heightOffset);
                break;
