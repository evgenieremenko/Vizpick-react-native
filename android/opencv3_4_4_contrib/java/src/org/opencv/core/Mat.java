...
public class Mat {
    ...
    public void drawSquare(int size, int thickness, Point point, Scalar color) {
        Imgproc.drawMarker(this, point, color, Imgproc.MARKER_SQUARE, size, thickness, 8);
    }

    public void drawRegion(int size, int thickness, Region region, Scalar color) {
        Imgproc.line(this, region.getTl(), region.getTr(), color, thickness);
        Imgproc.line(this, region.getBl(), region.getBr(), color, thickness);
        Imgproc.line(this, region.getTl(), region.getBl(), color, thickness);
        Imgproc.line(this, region.getTr(), region.getBr(), color, thickness);
    }
}
